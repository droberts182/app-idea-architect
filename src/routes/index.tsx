    ...
    <>
      ...
      <section className="rule-bottom">
        <div className="container-page grid gap-10 py-20 md:grid-cols-[1.6fr_1fr] md:py-28">
          ...
          <aside className="rule-top md:rule-top-0 flex flex-col justify-start gap-6 pt-6 md:border-l md:border-t-0 md:pl-10 md:pt-0">
            <Stat n="19+" label="Years experience building mobile app solutions for customers" />
            <Stat n="1M+" label="Apps downloaded millions of times" />
      ...
      <section className="rule-bottom">
        <div className="container-page py-20">
          ...
          <div className="mt-12 eyebrow">What sets us apart</div>
